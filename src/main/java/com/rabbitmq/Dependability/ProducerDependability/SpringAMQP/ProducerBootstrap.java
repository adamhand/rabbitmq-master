...
public class ProducerBootstrap {
    ...
    public static void main(String[] args) {
         ...
         * 发布消息
         */
        rabbitTemplate.send(EXCHANGE_NAME, ROUTING_KEUY, msg, new CorrelationData("201910704116"));
        rabbitTemplate.send(EXCHANGE_NAME, ROUTING_KEUY+"xxx", msg, new CorrelationData("201910704223"));
    }
}
